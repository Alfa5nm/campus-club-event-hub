...
<section class="editorial-section">
  <header class="editorial-heading"><div><span class="section-number">02</span><p>YOUR WEEK, EDITED</p></div><h2>Three reasons to<br>leave the group chat.</h2><a class="underlined-link" href="events.php">Full calendar →</a></header>
  <div class="story-grid"><?php foreach($featured as $i=>$event):?><article class="event-story reveal" style="--delay:<?=$i*90?>ms"><div class="story-image"><img src="<?=e($images[$i%count($images)])?>" alt=""><span><?=e(str_pad((string)($i+1),2,'0',STR_PAD_LEFT))?></span></div><div class="story-body"><span class="story-tag"><?=e($event['event_category'])?></span><h3><?=e($event['title'])?></h3><p><?=e($event['club_name'])?> · <?=e(date('M j',strtotime($event['event_date'])))?> · <?=e($event['venue'])?></p><div class="capacity"><span style="width:<?=min(100,round(((int)$event['registration_count']/(int)$event['maximum_participants'])*100))?>%"></span></div></div></article><?php endforeach;?></div>
</section>
<section class="club-spread"><div class="club-spread-intro"><span class="section-number">03</span><p>CLUB DIRECTORY</p><h2>Belong to<br>something.</h2><p>Not a mailing list. Not another forgotten group. Find the people building, debating, creating, and changing campus.</p><a class="button button-sun" href="clubs.php">Meet the clubs →</a></div><div class="club-stack"><?php foreach($clubs as $i=>$club):?><a href="clubs.php" class="club-line"><span>0<?=$i+1?></span><div><small><?=e(strtoupper($club['category']))?></small><h3><?=e($club['club_name'])?></h3></div><div><b><?=(int)$club['member_count']?></b><small>members</small></div><strong>↗</strong></a><?php endforeach;?></div></section>
