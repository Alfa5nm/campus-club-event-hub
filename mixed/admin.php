...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    redirect('mixed/admin.php?section=' . urlencode($type));
}
...
<section class="page-shell">
    <div class="page-head">
        ...
        <a class="button button-primary" href="<?= e(app_url('faisal/reports.php')) ?>">Open reports</a>
    </div>

    <nav class="filter-chips" aria-label="Administration sections">
        <?php foreach ($sections as $name): ?>
            <a class="filter-chip <?= $section === $name ? 'active' : '' ?>" href="<?= e(app_url('mixed/admin.php')) ?>?section=<?= e($name) ?>"><?= e(ucfirst($name)) ?></a>
        <?php endforeach; ?>
    </nav>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php if (isset($statusChoices[$section])): ?>
                                <form class="actions" method="post" data-ajax="<?= e(app_url('mixed/api/moderation.php')) ?>">
                            ...
                            <?php else: ?>
                                <a class="text-link" href="<?= e(app_url('rifat/attendance.php')) ?>">Manage attendance</a>
                            <?php endif; ?>
                        </td>
                    </tr>
                <?php endforeach; ?>
