...
?>
<section class="auth-page"><div class="auth-visual"><img src="<?= e(app_url('mixed/assets/images/campus-walk.jpg')) ?>" alt="Students walking through campus"><div class="auth-caption"><span>JOIN THE DIRECTORY</span><h1>Start with<br>hello.</h1></div></div><div class="form-shell wide">
    ...
    <p class="auth-note">Already registered? <a href="<?= e(app_url('mixed/login.php')) ?>"><strong>Sign in</strong></a></p>
</div></section>
