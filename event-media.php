...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    redirect('event-media.php?event_id=' . $eventId);
}
...
<section class="page-shell narrow-shell">
    ...
    <?php if ($event['poster']): ?><img class="media-preview" src="<?= e($event['poster']) ?>" alt="Current event poster"><?php endif; ?>
    <form class="card editor-card" method="post" enctype="multipart/form-data">
        ...
        <button class="button button-primary">Upload poster</button> <a class="button button-quiet" href="events.php">Back</a>
    </form>
</section>
