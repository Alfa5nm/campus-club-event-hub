...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    redirect('gallery.php?club_id=' . $clubId);
}
...
<section class="page-shell">
    <div class="page-head">
        ...
        <a class="button button-quiet" href="clubs.php">Back to clubs</a>
    </div>
    ...
    <div class="grid gallery-grid">
        <?php foreach ($photos as $photo): ?>
            <figure class="card gallery-item">
                <img src="<?= e($photo['photo_path']) ?>" alt="<?= e($photo['caption'] ?? $club['club_name']) ?>">
