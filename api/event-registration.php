...
if ($action === 'cancel_registration') {
    ...
    notify_user($userId, 'Registration Cancellation', 'Your event registration was cancelled.');
...
try {
    ...
    if (!$student->fetchColumn()) {
        throw new RuntimeException('Only student accounts can register.');
    }
    ...
    notify_user($userId, 'Registration Confirmation', 'Your registration for ' . $event['title'] . ' is confirmed.');
    db()->commit();
